...
export interface TcRcTableProps<T = any> extends TableProps<T> {
  headerHeight?: number
  isLoading?: boolean
  virtual?: boolean
  fixedTable?: boolean
...
const _TcRcTable = <T extends DefaultRecordType = any>({
  headerHeight = 42,
  columns,
  emptyText,
  isLoading,
...
import { TcSortTable } from "./sort-table"

export const TcRcTable = _TcRcTable as typeof _TcRcTable & {
  SortTable: typeof TcSortTable
}

TcRcTable.SortTable = TcSortTable

// TcRcTable.Virtual = VirtualTable
