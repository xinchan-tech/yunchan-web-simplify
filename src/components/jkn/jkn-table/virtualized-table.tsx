 ...
 * @returns
 */
const VirtualizedTable = <TData extends Record<string, unknown>, TValue>({
  className,
  style,
  ...props
}: JknTableProps<TData, TValue>) => {
                        ...
                        >
                          {row.getVisibleCells().map(cell => {
                            ...
                            return (
                              <td
                                key={cell.id}
                                className="jkn-table-virtualized-td"
                                style={{ width: cellWidth[cell.column.id] ?? 120 }}
                              >
