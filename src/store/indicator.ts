...
const defaultIndicatorParams: IndicatorParams[] = [
  ...
  },
  {
    id: '127',
    name: '神奇九转',
    params: [{ name: 'N', value: '15', min: '0', max: '1000' }]
  },
  {
    id: '122',
    name: 'BOLL',
  ...
  },
  {
    ...
    name: 'MACD',
    params: [
      { name: 'SHORT', value: '12', min: '2', max: '200' },
      { name: 'LONG', value: '26', min: '2', max: '200' },
      { name: 'M', value: '9', min: '2', max: '200' }
    ]
  },
  {
    id: '134',
    name: 'KDJ',
    params: [
      { name: 'P1', value: '9', min: '2', max: '90' },
      { name: 'P2', value: '3', min: '2', max: '30' },
      { name: 'P3', value: '3', min: '2', max: '30' }
    ]
  },
  {
    id: '135',
    name: 'RSI',
    params: [
      { name: 'P1', value: '6', min: '2', max: '120' },
      { name: 'P2', value: '12', min: '2', max: '250' },
      { name: 'P3', value: '24', min: '2', max: '500' }
    ]
  },
  {
    id: '141',
    name: 'CCI',
    params: [{ name: 'N', value: '14', min: '2', max: '100' }]
  },
  {
    id: '130',
    name: 'WWSR',
  ...
  },
  {
    ...
    name: 'PSY',
    params: [
      { name: 'N', value: '12', min: '2', max: '100' },
      { name: 'M', value: '6', min: '2', max: '100' }
    ]
  },
  {
    id: '140',
    name: 'BIAS',
    params: [
      { name: 'N1', value: '6', min: '2', max: '250' },
      { name: 'N2', value: '12', min: '2', max: '250' },
      { name: 'N3', value: '24', min: '2', max: '250' }
    ]
  },
  {
    id: '138',
    name: 'DMA',
    params: [
      { name: 'SHORT', value: '10', min: '2', max: '60' },
      { name: 'LONG', value: '50', min: '2', max: '250' },
      { name: 'M', value: '10', min: '2', max: '100' }
    ]
  },
  {
    id: '142',
    name: 'DMI',
    params: [
      { name: 'N', value: '14', min: '2', max: '90' },
      { name: 'M', value: '6', min: '2', max: '60' }
    ]
  },
  {
    id: '143',
  ...
  },
  {
    id: '147',
    name: 'ARBR',
    params: [{ name: 'N', value: '26', min: '2', max: '120' }]
  },
  {
    id: '137',
    name: 'CR',
    params: [
      { name: 'N', value: '26', min: '2', max: '100' },
      { name: 'M1', value: '5', min: '0', max: '100' },
      { name: 'M2', value: '10', min: '0', max: '100' },
      { name: 'M3', value: '20', min: '0', max: '100' },
      { name: 'M4', value: '60', min: '0', max: '100' },
      { name: 'M', value: '6', min: '0', max: '100' }
    ]
  },
  {
    id: '139',
  ...
  },
  {
    ...
    name: 'MAVOL',
    params: [
      { name: 'N1', value: '5', min: '0', max: '1000' },
      { name: 'N2', value: '10', min: '0', max: '1000' },
      { name: 'N3', value: '20', min: '0', max: '1000' }
    ]
  }
]
...
export const useIndicator = create<IndicatorStore>()(
  persist(
    (set, get) => ({
      ...
      setIndicatorParams: params => set({ indicatorParams: params }),
      isDefaultIndicatorParams: indicatorId => {
        ...
        return JSON.stringify(indicator) === JSON.stringify(
          get().indicatorParams.find(item => item.id === indicatorId)
        )
      }
    }),
    {
