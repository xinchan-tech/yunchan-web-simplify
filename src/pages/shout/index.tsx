...
const Shout = () => {
  ...
  return (
    <div className="h-full">
      <JknInfiniteArea
        className="h-full mx-auto w-[900px] border-0 border-x border-solid border-border overflow-x-hidden"
        ref={scroll}
      >
            ...
            <div key={order.id}>
              ...
              <div className="flex mt-4 mb-8 w-full">
                ...
                <div className="bg-[#00b44c] p-4 max-w-[760px] text-black rounded flex-1 relative">
                  <pre className="w-full break-all whitespace-pre-wrap text-base">{order.content}</pre>
                </div>
              </div>
            </div>
          ))}
