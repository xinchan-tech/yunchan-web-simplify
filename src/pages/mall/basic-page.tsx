...
import { Button, HoverCard, HoverCardContent, HoverCardTrigger, JknIcon, Popover, PopoverContent, PopoverTrigger } from "@/components"
                          ...
                          index === 2 && publicize[2] ? (
                            <HoverCard>
                              <HoverCardTrigger asChild>
                                <span>&nbsp;<JknIcon name="ic_tip1" className="w-3 h-3" /></span>
                              </HoverCardTrigger>
