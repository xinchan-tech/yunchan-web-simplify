  ...
  return (
    <div className="pt-24">
      ...
      <div className="home-content-w-1 mx-auto text-center text-[56px] font-bold">
        <p>
          TodayChart：No Trading<br /> 只有趋势图，3秒锁定趋势机会
        </p>
        <Button onClick={() => navigate('/mall')} className="linear-gradient-1 w-[160px] h-[56px] rounded-[300px] text-xl text-white cursor-pointer">
          立即加入
        </Button>
      </div>
      <div>
