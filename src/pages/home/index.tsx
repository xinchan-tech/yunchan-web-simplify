...
const HomePage = () => {
  ...
  return (
    <div className="home-container h-screen w-full overflow-y-auto bg-[#0A0A0A]">
      ...
      <div className="home-footer home-content-w-1 mx-auto my-24 ">
        <div className="home-logo w-[150px] h-[38px] ml-10">
          <img src={LogoTitle} alt="logo" className="size-full" />
        </div>
        <div className="space-x-4 my-2.5 ml-10">
        ...
        <div className="text-sm text-[#808080] flex justify-around">
