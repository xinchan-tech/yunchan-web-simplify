        ...
        <div className="max-w-[1000px] mx-auto px-12 box-border space-y-12">
          ...
          <details className="text-2xl border-0 border-b border-solid border-[#575757] pb-10" >
            ...
            <div className="text-xl mt-10 ">
              <div className="font-light">
                <span>别慌！</span><br />
                <span>打开“群聊”页面，点击 <span className="text-primary">“技术客服”</span> 直接提交反馈。我们会及时给您解决。</span>
              </div>
            </div>
          </details>
          <details className="text-2xl border-0 border-b border-solid border-[#575757] pb-10" >
            ...
            <div className="text-xl mt-10 ">
              <div className="font-light">
                ...
                <div className="mt-5 mb-2 font-bold">
                  <JknIcon name="trumpet" />&nbsp;<span>核心精神</span>
                </div>
          ...
          <details className="text-2xl border-0 border-b border-solid border-[#575757] pb-10" >
            ...
            <div className="text-xl mt-10 ">
              <div className="font-light">
                <div className="mt-5 mb-2 font-bold">
                  <JknIcon name="money" />&nbsp;<span>【推荐有礼 | TodayChart 分享佣金计划】</span>
                </div>
                <span>躺着赚美元的机会来了！</span>

                <div className="mt-5 mb-2 font-bold">
                  <JknIcon name="fire-2" />&nbsp;<span>【奖励规则】</span>
                </div>

                <span>推荐 1 位新用户订阅 → 白拿 20% 订阅金额积分！</span><br />
                <span>积分 = 现金！可兑换软件会员 / 抵扣现金 / 解锁高级功能</span>

                <div className="mt-5 mb-2 font-bold">
                  <span>点击<Link to="/user/invite" className="underline !decoration-primary !text-primary">「我的分享链接」</Link>→「推荐好友」</span>
                </div>
              </div>
            </div>
          </details>
