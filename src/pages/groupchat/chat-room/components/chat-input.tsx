...
import { type PropsWithChildren, forwardRef, useCallback, useEffect, useId, useImperativeHandle, useState } from 'react'
import { useImmer } from 'use-immer'
import { type Channel, type MessageContent, Reply, WKSDK } from 'wukongimjssdk'
...
export const ChatInput = forwardRef<ChatInputInstance, ChatInputProps>((props, ref) => {
  ...
  const [replyMessage, setReplyMessage] =
    useImmer<Nullable<{ name: string; text: string; uid: string; content: MessageContent }>>(null)
