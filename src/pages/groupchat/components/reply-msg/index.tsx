...
const ReplyMsg = (props: {
  ...
  const renderReplyContent = () => {
    ...
    if (message.content.reply.content instanceof MessageImage) {
      return <img src={message.content.reply.content.remoteUrl} className="max-h-[80px] max-w-[100px]" alt="" />
    }
  }
  return (
    <div className={cn('flex mb-6 pl-14 pr-14', message.send && 'justify-end')}>
      <div
        ...
        onClick={() => {
          typeof locateMessage === 'function' && locateMessage(message?.content.reply.messageSeq)
        }}
      >
