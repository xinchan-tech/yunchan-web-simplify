...
import { JknVirtualList } from '@/components/tc/jkn-virtual-list'
    ...
    <Popover modal open={open} onOpenChange={v => !v && setOpen(false)}>
      <PopoverTrigger asChild>
        <div className="flex items-center h-[50px] ml-auto overflow-hidden flex-1">
          <div
            className={cn(
              'flex items-center border border-input border-solid rounded-md px-2.5 py-1.5 box-border flex-1 overflow-hidden h-full',
