...
export const BullArrow = () => {
  return (
    ...
    <svg width="10" height="16" viewBox="0 0 10 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M5.35355 2.64645C5.15829 2.45118 4.84171 2.45118 4.64645 2.64645L1.46447 5.82843C1.2692 6.02369 1.2692 6.34027 1.46447 6.53553C1.65973 6.7308 1.97631 6.7308 2.17157 6.53553L5 3.70711L7.82843 6.53553C8.02369 6.7308 8.34027 6.7308 8.53553 6.53553C8.7308 6.34027 8.7308 6.02369 8.53553 5.82843L5.35355 2.64645ZM4.5 13C4.5 13.2761 4.72386 13.5 5 13.5C5.27614 13.5 5.5 13.2761 5.5 13L4.5 13ZM4.5 3L4.5 13L5.5 13L5.5 3L4.5 3Z"
        fill="#22AB94"
      />
    </svg>
  )
...
export const BearArrow = () => {
  return (
    ...
    <svg width="10" height="16" viewBox="0 0 10 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M4.64645 13.3536C4.84171 13.5488 5.15829 13.5488 5.35355 13.3536L8.53553 10.1716C8.7308 9.97631 8.7308 9.65973 8.53553 9.46447C8.34027 9.2692 8.02369 9.2692 7.82843 9.46447L5 12.2929L2.17157 9.46447C1.97631 9.2692 1.65973 9.2692 1.46447 9.46447C1.2692 9.65973 1.2692 9.97631 1.46447 10.1716L4.64645 13.3536ZM5.5 3C5.5 2.72386 5.27614 2.5 5 2.5C4.72386 2.5 4.5 2.72386 4.5 3L5.5 3ZM5.5 13L5.5 3L4.5 3L4.5 13L5.5 13Z"
        fill="#F23645"
      />
    </svg>
  )
      ...
      <div className="w-full pt-5 pb-8 flex flex-col border-x-0 border-y border-solid border-[#2E2E2E]">
        {children.map(item => (
          <div className="flex flex-row mt-5" key={item.id}>
            <div
              className="w-[132px] text-base font-[500] flex-shrink-0 flex-grow-0"
              style={{
