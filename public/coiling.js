var CoilingModule = (() => {
  ...
  return async (moduleArg = {}) => {
    ...
    var UTF8ArrayToString = (heapOrArray, idx = 0, maxBytesToRead = Number.NaN) => {
    ...
    var bigintToI53Checked = num => (num < INT53_MIN || num > INT53_MAX ? Number.NaN : Number(num))
    ...
    var _coiling_calculate = (Module['_coiling_calculate'] = wasmExports['M'])
    var ___getTypeName = wasmExports['N']
    var _malloc = wasmExports['O']
    var _free = wasmExports['P']
    var __emscripten_stack_restore = wasmExports['Q']
    var __emscripten_stack_alloc = wasmExports['R']
    var _emscripten_stack_get_current = wasmExports['S']
    Module['ccall'] = ccall
    Module['cwrap'] = cwrap
    function run() {
      if (runDependencies > 0) {
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = CoilingModule
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = CoilingModule
} else if (typeof define === 'function' && define['amd']) define([], () => CoilingModule)
